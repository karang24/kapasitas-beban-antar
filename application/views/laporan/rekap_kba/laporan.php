              ...
              <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2> Laporan Penempatan Barang<a class="close-link">
                              </a>                                    </h2>
                              
                                    <div class="clearfix"></div>
                              </div>
                                <div class="x_content">
                                            <div class="col-md-0 col-sm-0 col-xs-0 col-md-offset-0"></div>
                                        </div>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $rows->no_penempatan;?> </td>
                                          <td><?php echo $rows ->tgl_penempatan;?> </td>
                                          <td><?php echo $rows->kd_ruangan;?> </td>
                                          <td><?php echo $rows ->id_petugas;?> </td>
                                          <td><?php echo $rows ->jumlah_alokasi;?> </td>
