...
<th>Tanggal Pengiriman</th>
		 ...
		 ;?>                     <td><?php echo $rng->t_pengiriman;?></td>
                                        ...
                                        <td align="left">
                                          <a  href="<?php echo site_url();?>/C_kba/updatedata1/<?php echo $rng ->id_kba;?>"class="btn btn-xs btn-default"title="Edit" >
                                              <i class="fa fa-edit fa-fw"></i>
                                          </a>      
                                          <a onclick="return confirm('Anda yakin akan menghapus transaksi ini  <?php echo $rng ->id_kba;?> ?')" href="<?php echo site_url();?>/C_kba/deletedata1/<?php echo $rng->id_kba;?>" class="btn btn-xs btn-default" title="Hapus">
