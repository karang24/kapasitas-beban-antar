...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                     <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>index.php/C_kba/insertkba">
 ...
 <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kd_ruangan">Kantor <span class="required">*</span>
                                                ...
                                                <div class="col-md-2 col-sm-2 col-xs-7">
         <input id="id_kantor" class="form-control col-md-2 col-xs-3" data-validate-length-range="2" name="id_kantor" placeholder="Contoh : R101 " required="required" type="text" value=" <?php $this->load->library('session');
	  $session_id = $this->session->userdata('id_kantor');
	  ?><?php print $session_id;?>" readonly="readonly">
                                            </div>
                                        </div>
...
<input name="t_pengiriman" id="t_pengiriman" type="date"  />
                                            </div>
                                        </div>
                                       <div class="item form-group">
