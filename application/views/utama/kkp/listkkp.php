                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/c_kkp/addpetugas">
                                    ...
                                    <table id="dataTable" class="table table-striped responsive-utilities jambo_table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $a ->nippos;?> </td>
                                          <td><?php echo $a ->Nama_petugas;?> </td>
                                          <td><?php echo $a->alamat;?> </td>
                                          <td><?php echo $a->jabatan;?> </td>
                                          <td><?php echo $a->no_hp;?> </td>
                                          <td align="left">
                                            <a  href="<?php echo site_url();?>/C_kkp/updatedata/<?php echo $a ->nippos;?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                           <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $a->Nama_petugas;?> ?')" href="<?php echo site_url();?>/C_kkp/deletepetugas/<?php echo $a ->nippos;?>" class="btn btn-xs btn-default" title="Hapus">
