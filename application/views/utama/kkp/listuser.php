                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/c_kkp/adduser">
                                    ...
                                    <table id="dataTable" class="table table-striped responsive-utilities jambo_table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td align="left">
                                            <a  href="<?php echo site_url();?>/C_kkp/updateuser/<?php echo $a->id_user;?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                           <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $a->nippos;?> ?')" href="<?php echo site_url();?>/C_kkp/deleteuser/<?php echo $a ->id_user;?>" class="btn btn-xs btn-default" title="Hapus">
