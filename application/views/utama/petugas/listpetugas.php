            ...
            <div class="right_col" role="main">
              <div class="">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                            ...
                                            <form method="post" action="<?php echo base_url();?>index.php/c_petugas/addpetugas">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>View <small>Data Petugas</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                                        <li class="dropdown">
                                ...
                                <?php if(@$hasil):?>
                                    <table id="dataTable" class="table table-striped responsive-utilities jambo_table">
                                      ...
                                      <tbody>
                                        <?php $i=1;?>
                                        <?php foreach ($hasil as $brg): ?>
                                        <tr>
                                          <td align="center"><?php echo $i++?></td>
                                          <td><?php echo $brg ->nippos;?> </td>
                                          <td><?php echo $brg ->Nama_petugas;?> </td>
                                          <td><?php echo $brg->alamat;?> </td>
                                          <td><?php echo $brg->jabatan;?> </td>
                                          <td><?php echo $brg->no_hp;?> </td>
                                          <td align="left">
                                            <a  href="<?php echo site_url();?>/C_petugas/updatedata/<?php echo $brg ->nippos;?>"class="btn btn-xs btn-default"title="Edit" >
                                                <i class="fa fa-edit fa-fw"></i>
                                            </a>      
                                           <a onclick="return confirm('Anda yakin akan menghapus  <?php echo $brg->Nama_petugas;?> ?')" href="<?php echo site_url();?>/C_petugas/deletepetugas/<?php echo $brg ->nippos;?>" class="btn btn-xs btn-default" title="Hapus">
