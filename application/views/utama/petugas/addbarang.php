                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                  <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>index.php/C_petugas/insertpetugas">
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="nama_petugas" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" name="nama_petugas" placeholder="Nama Petugas" required="required" type="text">
                                                  <input id="id_kantor" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" name="id_kantor" placeholder="Nama Petugas" required="required" type="hidden" value=" <?php $this->load->library('session');
