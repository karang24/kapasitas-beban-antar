                                   ...
                                   <form class="form-horizontal form-label-left" method="post" action="<?php echo site_url('C_kkp/updatedata');?>" enctype="multipart/form-data">   
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="<?php echo $hasil->nippos ;?>" readonly id="nippos" class="form-control col-md-7 col-xs-5" data-validate-length-range="1" name="nippos" placeholder="Inputkan Kode Inventaris"  type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
